...
function finalProcess(){
							...
							url:"../process.php",
							type:"POST",
							data:{service:$('#service_type').val(),newfollow:$("#followersTag option:selected ").text(),email:$("#user_email").val(),username:$("#user_id").val(),userId:$("#userId").val(),fans:jQuery('#fans').val(),plan_type:$("#plan_type").val(),pay_amount:$("#followersTag").val(),mobile:1,page:"fans",manual:1},
